...
class movieController {
    async list(req, res, next) {
        try {
            ...
            sortKey=sortKey==='popularity'?'99popularity':sortKey||'name';
            ...
            const data = await movieRepository.getAll(condition,sort,page,pageSize);
            const total=await movieRepository.getCount();
